...
include_once('PEAR/docs/Mail_Mime/scripts/phail.php');
include_once('PEAR/docs/Mail_Mime/mime.php');

//Settings
$max_allowed_file_size = 10000; // size in KB
$allowed_extensions = array("jpg", "jpeg", "gif", "bmp");
$upload_folder = './upload_folder/'; //<-- this folder must be writeable by the script
$your_email = 'jgraef3@kent.edu';//<<--  update this to your email address
